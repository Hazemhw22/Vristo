    ...
    <div className="mb-10 bg-blue-50 p-6 rounded-lg">
      ...
      <div className="relative" {...swipeHandlers}>
        ...
        {startIndex > 0 && (
          <button
            onClick={handlePrev}
            className="absolute left-0 top-1/2 -translate-y-1/2 bg-white shadow-md rounded-full p-2 cursor-pointer"
          >
        ...
        {startIndex + itemsPerPage < products.length && (
          <button
            onClick={handleNext}
            className="absolute right-0 top-1/2 -translate-y-1/2 bg-white shadow-md rounded-full p-2 cursor-pointer"
          >
